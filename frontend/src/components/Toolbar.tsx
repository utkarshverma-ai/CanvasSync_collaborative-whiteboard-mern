...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <>
      <aside className="toolbar-tool-dock" role="toolbar" aria-label="Drawing tools">
        {drawingTools}
      </aside>

      <div className="toolbar-dock" role="toolbar" aria-label="Board controls">
        <div className="toolbar-mobile-primary" role="group" aria-label="Drawing tools">
          {drawingTools}
        </div>
